...
SOURCES = main.c lexer/lexer.c lexer/utils_lexer.c lexer/utils_lex_aux.c prompt.c parser/parser.c \
		...
		execution/execution.c execution/execution_cmd.c execution/heredoc.c execution/heredoc_utils.c execution/redirections.c \
		execution/path_helper_funcs.c execution/envp.c execution/ex_helper.c execution/execution_aux.c \
